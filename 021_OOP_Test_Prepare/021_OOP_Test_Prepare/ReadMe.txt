========================================================================
    KONSOLENANWENDUNG: 021_OOP_Test_Prepare-Projektübersicht
========================================================================

Diese 021_OOP_Test_Prepare-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre 021_OOP_Test_Prepare-Anwendung besteht.


021_OOP_Test_Prepare.vcxproj
...
021_OOP_Test_Prepare.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen 021_OOP_Test_Prepare.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
