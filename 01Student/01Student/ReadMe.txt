========================================================================
    KONSOLENANWENDUNG: 01Student-Projektübersicht
========================================================================

Diese 01Student-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre 01Student-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen 01Student.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
