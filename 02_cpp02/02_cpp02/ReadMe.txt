========================================================================
    KONSOLENANWENDUNG: 02_cpp02-Projektübersicht
========================================================================

Diese 02_cpp02-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre 02_cpp02-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen 02_cpp02.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
