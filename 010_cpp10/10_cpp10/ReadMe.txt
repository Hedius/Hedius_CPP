========================================================================
    KONSOLENANWENDUNG: 10_cpp10-Projektübersicht
========================================================================

Diese 10_cpp10-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre 10_cpp10-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen 10_cpp10.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
